    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="http://localhost:5174/" class="btn btn-primary">Sito Guest</a> <!-- Link al sito guest DA CAMBIARE IN BASE ALL'INDIRIZZO LOCALE di npm run dev di Vite del Progetto Vue -->
                </li>
