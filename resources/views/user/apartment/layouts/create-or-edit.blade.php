                ...
                <form action="@yield('form-action')" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group d-flex flex-wrap" role="group"
                            ...
                            @foreach ($tags as $tag)
                                @if ($errors->any())
                                    <input name="tags[]" type="checkbox" class="btn-check"
                                        id="tag-check-{{ $tag->id }}" autocomplete="off" value="{{ $tag->id }}"
                                ...
                                @endif
                                <label class="btn btn-outline-primary mb-2 d-inline-block"
                                    for="tag-check-{{ $tag->id }}">{{ $tag->name }}</label>
                            @endforeach
                        </div>
                        @error('tags')
                            <div class="alert alert-danger">
                    ...
                    <div class="mb-3">
                        <label for="link">Link del progetto:</label>
                        <input type="url" name="link" id="link" class="form-control mb-2"
                    ...
                    <input type="reset" value="Reimposta campi" class="btn btn-warning btn-sm">
