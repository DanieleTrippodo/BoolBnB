    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-3" style="width: 100%;">
                ...
                @else
                    <img src="https://via.placeholder.com/800x400" class="card-img-top" alt="No Image Available">
                @endif
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><strong>Creato il:</strong> {{ $apartment->created_at->format('d/m/Y H:i') }}</li>
                    <li class="list-group-item"><strong>Ultimo aggiornamento:</strong> {{ $apartment->updated_at->format('d/m/Y H:i') }}</li>
                </ul>
                ...
                <div class="card-body">
                    <a href="{{ route('user.apartments.index') }}" class="btn btn-secondary">Torna agli appartamenti</a>
                    <a href="{{ route('user.apartments.edit', $apartment->id) }}" class="btn btn-primary">Modifica appartamento</a>
                </div>
            </div>
        </div>
    </div>
