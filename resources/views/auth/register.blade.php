                    ...
                    <form id="registerForm" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">
                                {{ __('Indirizzo Email') }} <span style="color: var(--color-secondary);">*</span>
                            </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <span id="emailError" style="color: var(--color-secondary); display: none;"></span>
                                @error('email')
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">
                                {{ __('Password') }} <span style="color: var(--color-secondary);">*</span>
                            </label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm"
                                class="col-md-4 col-form-label text-md-end">{{ __('Conferma Password') }}<span
                                    style="color: var(--color-secondary);">*</span></label>

                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control"
                                    name="password_confirmation" required autocomplete="new-password">
                                <span id="passwordMismatch" style="color: var(--color-secondary); display: none;">Le password non coincidono.</span>
                            </div>
                        </div>
